class GameManager {
  ...
  void displayScoreboard() {
    ...
    textAlign(CENTER, CENTER);
    textSize(20);
    String leftLabel = twoPlayerMode ? "P1: " + player1Score : "Comp: " + player1Score;
    text(leftLabel, 165, 50);
    text("P2: " + player2Score, 435, 50);
    if ((twoPlayerMode && currentPlayer==1) || (!twoPlayerMode && currentPlayer==2))
      fill(255,215,0);
    else fill(200);
    rect(75, 18, 180, 5, 2);
